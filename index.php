...
<head>
    <title>NOR | Registro Contable Digital</title>
                      ...
                      <ul class="nav-right">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  ...
                                  <span>Benjamin Fregoso</span> <!-- NOMBRE APELLIDO DB-->
                          ...
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <div class="user-details">
                                      <span id="more-details">Benjamin Fregoso<i class="fa fa-caret-down"></i></span> <!-- NOMBRE APELLIDO DB-->
                                  </div>
                              </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-green">$1,200</h4>
                                            ...
                                            <div class="col-xl-8 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Mi economía</h5>
                                                        <span class="text-muted">Gráfico de tus totales por día</span>
